...
class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http.authorizeHttpRequests(requests -> requests
                .requestMatchers(mvc.pattern(HttpMethod.POST, "/api/products")).access(hasScope("write")) //SCOPE_write authority
                .requestMatchers(mvc.pattern("/api/products")).access(hasScope("read")) //SCOPE_read authority
